...
public class Uintent {
    ...
    public static void intentDIYLeftToRight(final Activity activity, final Class<?> classes, final Bundle bundle, final int enterAnim,
        ...
        setAnim(activity, enterAnim, exitAnim);
    }

    private static void setAnim(Activity activity, int enterAnim, int exitAnim) {
//        activity.overridePendingTransition(enterAnim, exitAnim);
    ...
    public static void finishDIYLeftToRight(final Activity activity) {
        activity.finish();
        setAnim(activity, FINISH_DEFAULT_ENTER_ANIM, FINISH_DEFAULT_EXIT_ANIM);
    }

    public static void finishDIYBottomToTop(final Activity activity) {
        activity.finish();
        setAnim(activity, INTENT_TOP_TO_BOTTOM_OUT, INTENT_BOTTOM_TO_TOP_OUT);
    }
